# Summary
This repo is now a website! It can be found here: https://microsoft.github.io/ABS-CSA-Assets/welcome/


This repository contains public available samples and workshops from Microsoft AI Business Solutions Cloud Solution Architects (CSAs) as well as other experts in the field. It serves as a resource for developers to explore and learn from real-world scenarios and best practices.
...
We are always interested and willing to help the community! Please use [the Issues link](https://github.com/microsoft/ABS-CSA-Assets/issues) to provide feedback on samples, gaps or any questions you have!
